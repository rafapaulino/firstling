...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'firstling' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'firstling' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'firstling'),
			'200'       => esc_html__( 'Light 200', 'firstling'),
			'200italic' => esc_html__( 'Light 200 Italic', 'firstling'),
			'300'       => esc_html__( 'Book 300', 'firstling'),
			'300italic' => esc_html__( 'Book 300 Italic', 'firstling'),
			'400'       => esc_html__( 'Normal 400', 'firstling'),
			'regular'   => esc_html__( 'Normal 400', 'firstling'),
			'italic'    => esc_html__( 'Normal 400 Italic', 'firstling' ),
			'500'       => esc_html__( 'Medium 500', 'firstling' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'firstling' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'firstling'),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'firstling'),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'firstling' ),
			'700'       => esc_html__( 'Bold 700', 'firstling' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'firstling'),
			'800'       => esc_html__( 'Extra-Bold 800', 'firstling' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'firstling' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'firstling' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'firstling'),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'firstling' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'firstling'),
		);
	}
